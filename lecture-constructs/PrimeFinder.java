...
<meta content="practice/PrimeFinder.java · master · Yehia Elkhatib / ap-2021" property="og:title">
...
<meta content="https://git.dcs.gla.ac.uk/Yehia.Elkhatib/ap-2021/-/blob/master/practice/PrimeFinder.java" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="practice/PrimeFinder.java · master · Yehia Elkhatib / ap-2021" property="twitter:title">
...
<title>practice/PrimeFinder.java · master · Yehia Elkhatib / ap-2021 · GitLab</title>
...
<meta name="csrf-token" content="HyT/vzeLpLF6MQTPvzuYMRD77Bllv5Ga1SKdMVwlsRXeKKp8PY+HAbIYe8obiu6d31j6Jr9dwl2pGydSzeLciQ==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-mac" data-find-file="/Yehia.Elkhatib/ap-2021/-/find_file/master" data-namespace-id="208" data-page="projects:blob:show" data-page-type-id="master/practice/PrimeFinder.java" data-project="ap-2021" data-project-id="259">
...
<input type="hidden" name="path" id="path" value="practice/PrimeFinder.java" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/PrimeFinder.java"><strong>PrimeFinder.java</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/Yehia.Elkhatib/ap-2021/-/blame/master/practice/PrimeFinder.java">Blame</a><a class="gl-button btn btn-default" href="/Yehia.Elkhatib/ap-2021/-/commits/master/practice/PrimeFinder.java">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/Yehia.Elkhatib/ap-2021/-/blob/8c8d32fbf0ad4a14923b001d902a7c73cce649a5/practice/PrimeFinder.java">Permalink</a></div>
</div>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;practice/PrimeFinder.java&quot;,&quot;gfm&quot;:&quot;`practice/PrimeFinder.java`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
518 Bytes
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-event="click_edit" data-track-label="Edit" href="/Yehia.Elkhatib/ap-2021/-/edit/master/practice/PrimeFinder.java">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-event="click_edit_ide" data-track-label="Web IDE" data-track-property="secondary" href="/-/ide/project/Yehia.Elkhatib/ap-2021/edit/master/-/practice/PrimeFinder.java">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;d3ff7974ee00182cfbd50e1d6638d25c6cef4cfa&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/PrimeFinder.java"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#doc-code"></use></svg></a>
<a download="practice/PrimeFinder.java" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/PrimeFinder.java?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/PrimeFinder.java">Fork</a>
...
<div class="blob-viewer" data-path="practice/PrimeFinder.java" data-type="simple" data-url="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/PrimeFinder.java?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete PrimeFinder.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/PrimeFinder.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="/mR8ckdw+P3SDpcYqkaohoPD2Pk7uWbc5rXC6LfiPGI/aCmxTXTbTRon6B0O994qTGDOxuFbNRuajHiLJiVR/g==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-4183671a3a7987e3bd193d9f7a99519b">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4183671a3a7987e3bd193d9f7a99519b" class="form-control gl-form-input js-commit-message" placeholder="Delete PrimeFinder.java" data-qa-selector="commit_message_field" required="required" rows="3">
Delete PrimeFinder.java</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-f27a610b1cae2e7322a1b7c2e9e29ab7" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-f27a610b1cae2e7322a1b7c2e9e29ab7">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace PrimeFinder.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/Yehia.Elkhatib/ap-2021/-/update/master/practice/PrimeFinder.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="wk9YbEL3NyVrqt3YDoCFnH2fw5qamr4NN0Qu7ypSwZcDQw2vSPMUlaODot2qMfMwsjzVpUB47cpLfZSMu5WsCw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-c66e272aba3413b8838812c3ecf4eb12">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-c66e272aba3413b8838812c3ecf4eb12" class="form-control gl-form-input js-commit-message" placeholder="Replace PrimeFinder.java" data-qa-selector="commit_message_field" required="required" rows="3">
Replace PrimeFinder.java</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-6005e898970674e81abcd1c391196b8f" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-6005e898970674e81abcd1c391196b8f">Start a <strong>new merge request</strong> with these changes
</label></div>
