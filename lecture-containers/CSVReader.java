...
<meta content="practice/CSVReader.java · master · Yehia Elkhatib / ap-2021" property="og:title">
...
<meta content="https://git.dcs.gla.ac.uk/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVReader.java" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="practice/CSVReader.java · master · Yehia Elkhatib / ap-2021" property="twitter:title">
...
<title>practice/CSVReader.java · master · Yehia Elkhatib / ap-2021 · GitLab</title>
...
<meta name="csrf-token" content="wxYUMi5ERnHV8TuYiIKzckD77cLiKAJHJsJqa2MlrPgCGkHxJEBlwR3YRJ0sM8Xej1j7/TjKUYBa+9AI8uLBZA==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-mac" data-find-file="/Yehia.Elkhatib/ap-2021/-/find_file/master" data-namespace-id="208" data-page="projects:blob:show" data-page-type-id="master/practice/CSVReader.java" data-project="ap-2021" data-project-id="259">
...
<input type="hidden" name="path" id="path" value="practice/CSVReader.java" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVReader.java"><strong>CSVReader.java</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/Yehia.Elkhatib/ap-2021/-/blame/master/practice/CSVReader.java">Blame</a><a class="gl-button btn btn-default" href="/Yehia.Elkhatib/ap-2021/-/commits/master/practice/CSVReader.java">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/Yehia.Elkhatib/ap-2021/-/blob/1b0d151c03997c59f3c3e6b12094e41127ff7087/practice/CSVReader.java">Permalink</a></div>
</div>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;practice/CSVReader.java&quot;,&quot;gfm&quot;:&quot;`practice/CSVReader.java`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
1.05 KB
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-event="click_edit" data-track-label="Edit" href="/Yehia.Elkhatib/ap-2021/-/edit/master/practice/CSVReader.java">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-event="click_edit_ide" data-track-label="Web IDE" data-track-property="secondary" href="/-/ide/project/Yehia.Elkhatib/ap-2021/edit/master/-/practice/CSVReader.java">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;4ebd2caac87c5928230c7780c7ff3b26e6adc6aa&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/CSVReader.java"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#doc-code"></use></svg></a>
<a download="practice/CSVReader.java" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/CSVReader.java?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVReader.java">Fork</a>
...
<div class="blob-viewer" data-path="practice/CSVReader.java" data-type="simple" data-url="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVReader.java?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete CSVReader.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVReader.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="ybil5fC3U2Vpw9dndLYCJ2XIz3sSaOgWidudg/sRVPkItPAm+rNw1aHqqGLQB3SLqmvZRMiKu9H14ifgatY5ZQ==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-3dd3c4984d90e85c4217f764c75f08bf">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-3dd3c4984d90e85c4217f764c75f08bf" class="form-control gl-form-input js-commit-message" placeholder="Delete CSVReader.java" data-qa-selector="commit_message_field" required="required" rows="3">
Delete CSVReader.java</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-19285d55545f75ae78192245820c2b15" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-19285d55545f75ae78192245820c2b15">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace CSVReader.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/Yehia.Elkhatib/ap-2021/-/update/master/practice/CSVReader.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="00Ep5ake6XlKNhoTL/ZUZldzL4C+Ypqe/sIg1iqTCoASTXwmoxrKyYIfZRaLRyLKmNA5v2SAyVmC+5q1u1RnHA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-eac3fdb608b4fe00099a1e15aff0438a">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-eac3fdb608b4fe00099a1e15aff0438a" class="form-control gl-form-input js-commit-message" placeholder="Replace CSVReader.java" data-qa-selector="commit_message_field" required="required" rows="3">
Replace CSVReader.java</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-9d2b305f87f592481258e6fd533948a4" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-9d2b305f87f592481258e6fd533948a4">Start a <strong>new merge request</strong> with these changes
</label></div>
