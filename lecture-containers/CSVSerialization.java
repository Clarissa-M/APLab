...
<meta content="practice/CSVSerialization.java · master · Yehia Elkhatib / ap-2021" property="og:title">
...
<meta content="https://git.dcs.gla.ac.uk/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="practice/CSVSerialization.java · master · Yehia Elkhatib / ap-2021" property="twitter:title">
...
<title>practice/CSVSerialization.java · master · Yehia Elkhatib / ap-2021 · GitLab</title>
...
<meta name="csrf-token" content="vXtbscoV/FFfy2Xvjvx3IuYZH4rFpXO+rK41saKXmNV8dw5ywBHf4ZfiGuoqTQGOKboJtR9HIHnQl4/SM1D1SQ==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-mac" data-find-file="/Yehia.Elkhatib/ap-2021/-/find_file/master" data-namespace-id="208" data-page="projects:blob:show" data-page-type-id="master/practice/CSVSerialization.java" data-project="ap-2021" data-project-id="259">
...
<a href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java">Repository</a>
</h2>
</li>
</ul>
</div>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Yehia Elkhatib","item":"https://git.dcs.gla.ac.uk/Yehia.Elkhatib"},{"@type":"ListItem","position":2,"name":"ap-2021","item":"https://git.dcs.gla.ac.uk/Yehia.Elkhatib/ap-2021"},{"@type":"ListItem","position":3,"name":"Repository","item":"https://git.dcs.gla.ac.uk/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java"}]}
...
<div class="js-signature-container" data-signatures-path="/Yehia.Elkhatib/ap-2021/-/commits/b4a2b6a5a4b8cd636e3904ccb3dda46379a5d767/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="practice/CSVSerialization.java" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java"><strong>CSVSerialization.java</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/Yehia.Elkhatib/ap-2021/-/blame/master/practice/CSVSerialization.java">Blame</a><a class="gl-button btn btn-default" href="/Yehia.Elkhatib/ap-2021/-/commits/master/practice/CSVSerialization.java">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/Yehia.Elkhatib/ap-2021/-/blob/1b0d151c03997c59f3c3e6b12094e41127ff7087/practice/CSVSerialization.java">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-b4a2b6a5">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/Yehia.Elkhatib/ap-2021/-/commit/b4a2b6a5a4b8cd636e3904ccb3dda46379a5d767">practice problems added</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
b4a2b6a5
</span>
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="177" href="/Debasis.Ganguly">Debasis Ganguly</a> authored <time class="js-timeago" title="Jun 21, 2021 10:38pm" datetime="2021-06-21T22:38:01Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Jun 21, 2021</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/Yehia.Elkhatib/ap-2021/-/commit/b4a2b6a5a4b8cd636e3904ccb3dda46379a5d767/pipelines?ref=master"></div>
<div class="commit-sha-group btn-group d-none d-sm-flex">
<div class="label label-monospace monospace">
b4a2b6a5
</div>
<button class="btn gl-button btn btn-default btn-icon" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="gl-button btn btn-default btn-icon" data-clipboard-text="b4a2b6a5a4b8cd636e3904ccb3dda46379a5d767" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button>
...
CSVSerialization.java
</strong>
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;practice/CSVSerialization.java&quot;,&quot;gfm&quot;:&quot;`practice/CSVSerialization.java`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
1.63 KB
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-event="click_edit" data-track-label="Edit" href="/Yehia.Elkhatib/ap-2021/-/edit/master/practice/CSVSerialization.java">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-event="click_edit_ide" data-track-label="Web IDE" data-track-property="secondary" href="/-/ide/project/Yehia.Elkhatib/ap-2021/edit/master/-/practice/CSVSerialization.java">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;4474f8ca6300026c743e91cc24ef38ab4a34f9d7&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/CSVSerialization.java"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#doc-code"></use></svg></a>
<a download="practice/CSVSerialization.java" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/Yehia.Elkhatib/ap-2021/-/raw/master/practice/CSVSerialization.java?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-6d7d4be41eac996c72b30eac2f28399ac8c6eda840a6fe8762fc1b84b30d5a2d.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java">Fork</a>
...
<div class="blob-viewer" data-path="practice/CSVSerialization.java" data-type="simple" data-url="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete CSVSerialization.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/Yehia.Elkhatib/ap-2021/-/blob/master/practice/CSVSerialization.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="8MBBZTbY+6MUp7GXa3x01oLsc84a61C1qsU0a/SWtLkxzBSmPNzYE9yOzpLPzQJ6TU9l8cAJA3LW/I4IZVHZJQ==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-2697cc79a36c04f9d5cafb70ffaca6a7">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-2697cc79a36c04f9d5cafb70ffaca6a7" class="form-control gl-form-input js-commit-message" placeholder="Delete CSVSerialization.java" data-qa-selector="commit_message_field" required="required" rows="3">
Delete CSVSerialization.java</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-60f8234b660d0d3eb7aa54fd316560fe" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-60f8234b660d0d3eb7aa54fd316560fe">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace CSVSerialization.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/Yehia.Elkhatib/ap-2021/-/update/master/practice/CSVSerialization.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="cfLMDS4+JNAzOV3LiMc24NrMT3kghWChEyjdfp9R7jGw/pnOJDoHYPsQIs4sdkBMFW9ZRvpnM2ZvEWcdDpaDrQ==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-ef7a6a105f8913c67ee456d474d51ebe">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ef7a6a105f8913c67ee456d474d51ebe" class="form-control gl-form-input js-commit-message" placeholder="Replace CSVSerialization.java" data-qa-selector="commit_message_field" required="required" rows="3">
Replace CSVSerialization.java</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-abb466dd85109d4fefd7839cf646ee0a" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-abb466dd85109d4fefd7839cf646ee0a">Start a <strong>new merge request</strong> with these changes
</label></div>
